    ...
    auiSharebox.prototype = {
        ...
        open: function(params,callback) {
            ...
            if(self.buttons && self.buttons.length){
                ...
                buttonsHtml = '<div class="aui-row aui-row-padded"><div class="aui-sharebox-close-btn"><i style="float: right;right: 1rem;" class="aui-iconfont aui-icon-close aui-font-size-16"></i></div>';
                for(var i = 0; i < self.buttons.length;i++){
                    if(self.col == 5){
                        buttonsHtml += '<div  class="aui-col-5 aui-sharebox-btn">';
                    }else if(self.col == 2 &&i==0){
                    	buttonsHtml += '<div  class="aui-text-center  aui-sharebox-btn aui-border-b aui-padded-b-10">';
                    }else if(self.col == 2&&i!=0){
                    	buttonsHtml += '<div  class="aui-text-center aui-col-xs-'+(12/self.col)+' aui-sharebox-btn">';
                    }else{
